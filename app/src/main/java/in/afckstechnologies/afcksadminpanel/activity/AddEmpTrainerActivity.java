...
public class AddEmpTrainerActivity extends AppCompatActivity {
    private Spinner spnrUserType;
    CheckBox  chkSelectedEmpWFH, chkSelectedEmpFees;
    Button placeBtn;
    ...
    String addUserRespone = "", msg = "", statusResponse = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_emp_trainer);
    ...
    private class updateRoleStatusData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(AddEmpTrainerActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            addUserRespone = serviceAccess.SendHttpPost(Config.URL_ADDNEWEMPTRAINERS, jsonLeadObj);
